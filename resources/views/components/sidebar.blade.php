...
<!-- Mobilní bottom navbar - také s rozbalovacím menu pro Event -->
<nav class="navbar fixed-bottom bg-white border-top d-md-none p-2 shadow-lg">
    <div class="container-fluid px-0 h-100">
        <div class="d-flex w-100 h-100 justify-content-around align-items-center">
            ...
            <!-- Event s rozbalovacím menu na mobilu -->
...
<!-- <div class="bg-white d-none d-md-flex flex-column p-3 h-100 position-sticky z-2">
