    ...
    <div class="container-fluid">
        ...
        <div class="d-none d-md-flex position-absolute start-50 translate-middle-x align-items-center" id="search">
            <div class="position-relative w-100">
                <input type="search" class="form-control rounded-pill border-secondary-subtle shadow-none py-2 fs-5 px-4">
                <img src="{{ Vite::asset('resources/svg/search.svg') }}" class="position-absolute end-0 top-50 translate-middle-y me-3">
            </div>
        </div>
