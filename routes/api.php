...
// EVENT ROUTES
// get
Route::get('/events', [EventController::class, 'search'])->name('event.search'); // List events
...
Route::post('/event/{event}/set-attends', [EventController::class, 'setAttendance'])
    ->middleware('auth')->name('event.setAttendance');

// GROUP ROUTES
// get
Route::get('/users', [UserController::class, 'search'])->name('user.search'); // List users
...
Route::get('/groups', [GroupController::class, 'search'])->name('group.seach'); // List groups
...
// SETTINGS ROUTES
// get
Route::get('/settings', [SettingController::class, 'search'])->name('settings.search')
    ->middleware('auth');
